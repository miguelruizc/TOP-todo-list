...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/styleDark.css":
/*!*****************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/styleDark.css ***!
  \*****************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* Dark theme counterpart */
...
#main {
    ...
    box-shadow: 5px -5px 0px rgba(255, 255, 255, 1); /* Adjusted shadow color */
    padding: 20px;
    background-color: #00000000; /* Darker background */
}

.project {
    border: 1px solid #474747; /* Lighter border */
    margin-bottom: 10px;
    padding: 10px;
    width: 100%;
    box-shadow: 1px 1px 2px rgba(255, 255, 255, 0.1); /* Adjusted shadow color */
}

.todo {
    border: 1px solid #303030; /* Lighter border */
    margin-bottom: 5px;
    padding: 5px;
    width: 100%;
}
...
dialog {
    ...
    width: 90%;
    box-shadow: 2px -2px 0px 1px rgba(255,255,255,1);
}

/* Remove default dialog styling */
dialog::-webkit-backdrop {
    background-color: rgba(255, 255, 255, 0.3); /* Adjusted backdrop color */
}

/* PHASE 3 */
/* Center form elements vertically and horizontally */
dialog form {
    display: flex;
    flex-direction: column;
    align-items: center;
...
.todo:hover,
.dialog:hover {
    animation: galacticNebula 20s linear infinite;
}


button:hover {
    animation: galacticNebula 1s linear infinite;
}

@keyframes galacticNebula {
    0% { background-color: #9932cc; } /* DarkOrchid */
    14% { background-color: #00ffff; } /* Cyan */
    28% { background-color: #ba55d3; } /* MediumOrchid */
    42% { background-color: #8a2be2; } /* BlueViolet */
    57% { background-color: #4169e1; } /* RoyalBlue */
    71% { background-color: #9932cc; } /* DarkOrchid */
    85% { background-color: #00ffff; } /* Cyan */
    100% { background-color: #ba55d3; } /* MediumOrchid */
}

@keyframes galacticNebula60 {
    0% { background-color: #9932cc60; } /* DarkOrchid */
    14% { background-color: #00ffff60; } /* Cyan */
    28% { background-color: #ba55d360; } /* MediumOrchid */
    42% { background-color: #8a2be260; } /* BlueViolet */
    57% { background-color: #4169e160; } /* RoyalBlue */
    71% { background-color: #9932cc60; } /* DarkOrchid */
    85% { background-color: #00ffff60; } /* Cyan */
    100% { background-color: #ba55d360; } /* MediumOrchid */
}`, "",{"version":3,"sources":["webpack://./src/styleDark.css"],"names":[],"mappings":"AAAA,2BAA2B;;AAE3B,YAAY;AACZ;IACI,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,WAAW,EAAE,eAAe;AAChC;;AAEA;IACI,aAAa;IACb,eAAe;AACnB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;;IAEI,eAAe;AACnB;;AAEA;IACI,eAAe;IACf,SAAS;IACT,UAAU;IACV,sBAAsB;IACtB,WAAW,EAAE,eAAe;AAChC;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,iBAAiB;IACjB,sBAAsB,EAAE,oBAAoB;AAChD;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,UAAU;IACV,gBAAgB,EAAE,qBAAqB;IACvC,+CAA+C,EAAE,0BAA0B;IAC3E,aAAa;IACb,2BAA2B,EAAE,sBAAsB;AACvD;;AAEA;IACI,yBAAyB,EAAE,mBAAmB;IAC9C,mBAAmB;IACnB,aAAa;IACb,WAAW;IACX,gDAAgD,EAAE,0BAA0B;AAChF;;AAEA;IACI,yBAAyB,EAAE,mBAAmB;IAC9C,kBAAkB;IAClB,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,WAAW;IACX,yBAAyB;IACzB,sBAAsB;IACtB,WAAW,EAAE,eAAe;AAChC;;AAEA;IACI,sBAAsB,EAAE,mBAAmB;AAC/C;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,sBAAsB,EAAE,sBAAsB;AAClD;;AAEA;IACI,sBAAsB,EAAE,sBAAsB;IAC9C,WAAW,EAAE,eAAe;AAChC;;AAEA;;;IAGI,kBAAkB;AACtB;;AAEA;IACI,yBAAyB,EAAE,mBAAmB;AAClD;;AAEA;IACI,sBAAsB,EAAE,sBAAsB;AAClD;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,SAAS;AACb;;AAEA,YAAY;AACZ,mBAAmB;AACnB;IACI,eAAe;IACf,QAAQ;IACR,SAAS;IACT,gCAAgC;IAChC,yBAAyB,EAAE,mBAAmB;IAC9C,sBAAsB,EAAE,sBAAsB;IAC9C,aAAa;IACb,gBAAgB,EAAE,qBAAqB;IACvC,UAAU;IACV,gDAAgD;AACpD;;AAEA,kCAAkC;AAClC;IACI,0CAA0C,EAAE,4BAA4B;AAC5E;;AAEA,YAAY;AACZ,qDAAqD;AACrD;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA,2CAA2C;AAC3C;IACI,kBAAkB;AACtB;;AAEA,uBAAuB;AACvB;IACI,WAAW;AACf;;AAEA;IACI,yBAAyB,EAAE,mBAAmB;IAC9C,WAAW,EAAE,eAAe;IAC5B,sBAAsB,EAAE,sBAAsB;IAC9C,eAAe;IACf,6CAA6C;IAC7C,iBAAiB;IACjB,kBAAkB;IAClB,gBAAgB;IAChB,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,sBAAsB,EAAE,sBAAsB;IAC9C,WAAW,EAAE,UAAU;AAC3B;;AAEA;IACI,kBAAkB;AACtB;;AAEA,wBAAwB;AACxB;;;IAGI,wBAAwB,EAAE,mBAAmB;IAC7C,sBAAsB,EAAE,mBAAmB;IAC3C,sBAAsB,EAAE,oBAAoB;IAC5C,WAAW,EAAE,eAAe;IAC5B,iBAAiB;IACjB,kBAAkB;IAClB,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA,yBAAyB;AACzB,oBAAoB;AACpB;;IAEI,6CAA6C;AACjD;;;AAGA;IACI,4CAA4C;AAChD;;AAEA;IACI,KAAK,yBAAyB,EAAE,EAAE,eAAe;IACjD,MAAM,yBAAyB,EAAE,EAAE,SAAS;IAC5C,MAAM,yBAAyB,EAAE,EAAE,iBAAiB;IACpD,MAAM,yBAAyB,EAAE,EAAE,eAAe;IAClD,MAAM,yBAAyB,EAAE,EAAE,cAAc;IACjD,MAAM,yBAAyB,EAAE,EAAE,eAAe;IAClD,MAAM,yBAAyB,EAAE,EAAE,SAAS;IAC5C,OAAO,yBAAyB,EAAE,EAAE,iBAAiB;AACzD;;AAEA;IACI,KAAK,2BAA2B,EAAE,EAAE,eAAe;IACnD,MAAM,2BAA2B,EAAE,EAAE,SAAS;IAC9C,MAAM,2BAA2B,EAAE,EAAE,iBAAiB;IACtD,MAAM,2BAA2B,EAAE,EAAE,eAAe;IACpD,MAAM,2BAA2B,EAAE,EAAE,cAAc;IACnD,MAAM,2BAA2B,EAAE,EAAE,eAAe;IACpD,MAAM,2BAA2B,EAAE,EAAE,SAAS;IAC9C,OAAO,2BAA2B,EAAE,EAAE,iBAAiB;AAC3D","sourcesContent":["/* Dark theme counterpart */\n\n/* PHASE 1 */\n.hide {\n    display: none;\n}\n\n.todoName {\n    cursor: pointer;\n    color: #ddd; /* Light gray */\n}\n\n.todo {\n    display: flex;\n    flex-wrap: wrap;\n}\n\n.todo > * {\n    flex-basis: 100%;\n}\n\n.deleteTodoButton,\n.editButton {\n    max-width: 30px;\n}\n\n* {\n    font-size: 12px;\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    color: #ddd; /* Light gray */\n}\n\nbody {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    min-height: 100vh;\n    background-color: #111; /* Dark background */\n}\n\n#main {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    width: 90%;\n    max-width: 600px; /* Adjust as needed */\n    box-shadow: 5px -5px 0px rgba(255, 255, 255, 1); /* Adjusted shadow color */\n    padding: 20px;\n    background-color: #00000000; /* Darker background */\n}\n\n.project {\n    border: 1px solid #474747; /* Lighter border */\n    margin-bottom: 10px;\n    padding: 10px;\n    width: 100%;\n    box-shadow: 1px 1px 2px rgba(255, 255, 255, 0.1); /* Adjusted shadow color */\n}\n\n.todo {\n    border: 1px solid #303030; /* Lighter border */\n    margin-bottom: 5px;\n    padding: 5px;\n    width: 100%;\n}\n\ntable {\n    width: 100%;\n    border-collapse: collapse;\n    font-family: monospace;\n    color: #ddd; /* Light gray */\n}\n\ntable, th, td {\n    border: 1px solid #666; /* Lighter border */\n}\n\nth, td {\n    padding: 5px 10px;\n    text-align: left;\n}\n\ntr:nth-child(even) {\n    background-color: #333; /* Darker background */\n}\n\nth {\n    background-color: #555; /* Darker background */\n    color: #ddd; /* Light gray */\n}\n\n.remove, \n.isReadTrue,\n.isReadFalse {\n    text-align: center;\n}\n\nbutton {\n    border: 1px solid #303030; /* Lighter border */\n}\n\nbutton:hover {\n    background-color: #444; /* Darker background */\n}\n\n.isReadFalse button {\n    color: transparent;\n}\n\n.form-buttons {\n    gap: 10px;\n}\n\n/* PHASE 2 */\n/* Center dialogs */\ndialog {\n    position: fixed;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    border: 1px solid #303030; /* Lighter border */\n    background-color: #111; /* Darker background */\n    padding: 20px;\n    max-width: 400px; /* Adjust as needed */\n    width: 90%;\n    box-shadow: 2px -2px 0px 1px rgba(255,255,255,1);\n}\n\n/* Remove default dialog styling */\ndialog::-webkit-backdrop {\n    background-color: rgba(255, 255, 255, 0.3); /* Adjusted backdrop color */\n}\n\n/* PHASE 3 */\n/* Center form elements vertically and horizontally */\ndialog form {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n/* Add some spacing between form elements */\ndialog form label {\n    margin-bottom: 5px;\n}\n\n/* Adjust input width */\ndialog form input {\n    width: 100%;\n}\n\nbutton {\n    border: 1px solid #303030; /* Lighter border */\n    color: #ddd; /* Light gray */\n    background-color: #222; /* Darker background */\n    cursor: pointer;\n    transition: background-color 0.3s, color 0.3s;\n    padding-left: 5px;\n    padding-right: 5px;\n    padding-top: 2px;\n    padding-bottom: 2px;\n    margin-right: 5px;\n}\n\nbutton:hover {\n    background-color: #444; /* Darker background */\n    color: #fff; /* White */\n}\n\n.isReadFalse button {\n    color: transparent;\n}\n\n/* Adjust input fields */\ndialog form input[type=\"text\"],\ndialog form input[type=\"date\"],\ndialog form input[type=\"number\"] {\n    width: calc(100% - 20px); /* Adjusted width */\n    border: 1px solid #666; /* Lighter border */\n    background-color: #333; /* Dark background */\n    color: #ddd; /* Light gray */\n    padding-left: 5px;\n    padding-right: 5px;\n    padding-top: 2px;\n    padding-bottom: 2px;\n}\n\n/* Rainbow hover effect */\n/* .project:hover, */\n.todo:hover,\n.dialog:hover {\n    animation: galacticNebula 20s linear infinite;\n}\n\n\nbutton:hover {\n    animation: galacticNebula 1s linear infinite;\n}\n\n@keyframes galacticNebula {\n    0% { background-color: #9932cc; } /* DarkOrchid */\n    14% { background-color: #00ffff; } /* Cyan */\n    28% { background-color: #ba55d3; } /* MediumOrchid */\n    42% { background-color: #8a2be2; } /* BlueViolet */\n    57% { background-color: #4169e1; } /* RoyalBlue */\n    71% { background-color: #9932cc; } /* DarkOrchid */\n    85% { background-color: #00ffff; } /* Cyan */\n    100% { background-color: #ba55d3; } /* MediumOrchid */\n}\n\n@keyframes galacticNebula60 {\n    0% { background-color: #9932cc60; } /* DarkOrchid */\n    14% { background-color: #00ffff60; } /* Cyan */\n    28% { background-color: #ba55d360; } /* MediumOrchid */\n    42% { background-color: #8a2be260; } /* BlueViolet */\n    57% { background-color: #4169e160; } /* RoyalBlue */\n    71% { background-color: #9932cc60; } /* DarkOrchid */\n    85% { background-color: #00ffff60; } /* Cyan */\n    100% { background-color: #ba55d360; } /* MediumOrchid */\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_styleDark_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./styleDark.css */ "./node_modules/css-loader/dist/cjs.js!./src/styleDark.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_styleDark_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_styleDark_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_styleDark_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_styleDark_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
class DOMInterface {
    ...
    addTodo(projectId) {
        ...
        const clickHandler = (event)=>{
            ...
            const todoDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(formData.get("newTodoDate")), "yyyy-MM-dd");
    ...
    editTodo(todo) {
        ...
        dateInput.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(todo.dueDate, "yyyy-MM-dd");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ProjectsInterface: () => (/* binding */ ProjectsInterface)
/* harmony export */ });
...
class ProjectsInterface {
    ...
    createProject(title) {
        let newProject = new _project_js__WEBPACK_IMPORTED_MODULE_0__.Project(title, this.createProjectId());
    ...
    createTodo(projectId = 0, title="Task", description="Task about X", dueDate=new Date(1111, 1, 1),
        ...
        let newTodo = new _todo_js__WEBPACK_IMPORTED_MODULE_1__.Todo(title, description, dueDate, priority, notes, isDone, this.createTodoId(projectId));
...
class Todo {
    ...
    toString(){
        return `${this.title}, ${this.description}, ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(this.dueDate,"dd,mm,yyyy")}, ${this.priority}, ${this.notes}, done:${this.isDone} id:${this.id}`;
    }
}
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styleDark_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styleDark.css */ "./src/styleDark.css");
/* harmony import */ var _DOMInterface_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOMInterface.js */ "./src/DOMInterface.js");
/* harmony import */ var _projectsInterface_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./projectsInterface.js */ "./src/projectsInterface.js");
...
if(loadData !== null) {
    ...
    tempArray.forEach((element)=>{
        ...
        const projectInstance = Object.assign(new _project_js__WEBPACK_IMPORTED_MODULE_3__.Project(), element);
        projectInstance.todoList = [];

        element.todoList.forEach((todo)=>{
            const todoInstance = Object.assign(new _todo_js__WEBPACK_IMPORTED_MODULE_4__.Todo(), todo);
...
const p = new _projectsInterface_js__WEBPACK_IMPORTED_MODULE_2__.ProjectsInterface(projects);
const d = new _DOMInterface_js__WEBPACK_IMPORTED_MODULE_1__.DOMInterface(p);
